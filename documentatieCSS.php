...
<body>
    ...
    <div id="Link" class="documentation">
        ...
        <p>
            ...
            Tag-ul link este indicat să fie plasat în partea de head a documentului HTML, deoarece este un element care nu este vizibil în conținutul propriu-zis al paginii.</p>
